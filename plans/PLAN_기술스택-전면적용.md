...
**기준 문서** `SRS/[SRS]hilit-SRSv1.7.md` (요구사항 원천) · `DS/[DS]hilit-DSv1.1.md` (설계) · `VPS_v0_3.html` (가치 원천)
...
*이 계획은 기술 스택 적용의 실행 순서와 가치 보존 판정을 담는다. 요구사항의 원천은 SRS v1.7이며, 이 문서가 요구사항을 새로 만들지 않는다. §1.3의 변경은 Phase 0 완료 후 SRS 개정으로 확정한다.*
