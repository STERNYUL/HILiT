...
| **N2 러닝 — 크루** ✏️ | ✅ 크루원이 찍어준다 | ✅ | ✅ | 🟡 **조건부 통과** — 🔴 **2026-09-03 정정** |
| N2 러닝 — 솔로 | 🚫 **혼자 달린다** | ✅ | — | 🚫 탈락 — 게이트 0 |
...
> 🔴 **2026-09-03 정정 — 러닝을 부분 복권했다.** 초판은 *"혼자 달린다"* 로 게이트 0에서 탈락시켰는데, **C5 정민혁 페르소나 카드(2026-08-28)에 *"크루원이 찍어주면 화면 어딘가에 점처럼 있다"* 가 이미 적혀 있었다.** 크루 러닝은 게이트 0·1을 함께 통과한다.
>
> **이 문서가 세운 원칙(①)을 이 문서가 어긴 것이다** — 여행·일상에는 "상황 단위로 판정한다"를 적용하고 러닝에는 적용하지 않았다. 상세는 [`페르소나 스펙트럼/06_6차보강_니치축-반영.md`](../../페르소나%20스펙트럼/06_6차보강_니치축-반영.md) 1절.
