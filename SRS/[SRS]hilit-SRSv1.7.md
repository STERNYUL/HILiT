...
| **v1.7** | **2026-08-30** | 🔴 **팀 SRS v1.0 전체 목차 대조 — 누락 6개 절 반영.** ① §2.2~2.4 **사용자 특성**(세그먼트 Q1~Q4 · 프로필 6유형 · **여정과 이탈 지점 도식**) ② **그림 4-1 유스케이스 다이어그램** ③ §6.3 **비즈니스 규칙 요약 10건** ④ §7 **시스템 모드 및 상태**(공개범위 상태전이도 · 편집 파이프라인) ⑤ §8 **향후 개선 사항** ⑥ §9 **다이어그램 색인**. REQ-FUNC-013에 **초대 링크 7일 · 롤백 · 회수 개수 경고** 보강 | `hilit-srs-v1_0.html` §2·4·6·7·9·12 |
