...
**성격:** `[SRS]hilit-SRSv1.6.md`와 **병렬 문서**. 기존 SRS를 대체하지 않는다.
...
| 문서 | 전제 | 답하는 것 |
| --- | --- | --- |
| `[SRS]hilit-SRSv1.6.md` | **기술 중립** | 무엇을 만족해야 하는가 |
...
| ID | 문서 |
| --- | --- |
| **TREF-01** | `[SRS]hilit-SRSv1.6.md` — 요구사항 원천 |
...
*이 문서는 `[SRS]hilit-SRSv1.6.md`를 대체하지 않는다. 요구사항의 원천은 v1.5이며, 이 문서는 지정된 기술 제약 하에서의 실현 가능성과 설계를 다룬다.*
